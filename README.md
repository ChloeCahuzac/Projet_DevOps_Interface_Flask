...
1. **Interface (console avec input et menu)** :
    ...
    - L'interface est composée de trois parties :
        1. Accueil : qui permet de rensigner les chemins des deux dossiers que l'on veut synchroniser
        2. Comparaison : qui permet de voir le contenu de nos deux fichiers ainsi que de pouvoir sélectionner un filtre si besoin
        3. Synchronisation : qui permet de synchronisaer les deux dossiers (en uni-directionnelle)
